      ...
      <div className="content-container content-miss content-news dk-flex dk-flex-col dk-font-Roboto dk-gap-4 dk-z-10 dk-items-center dk-mb-7">
        <div className="dk-w-[1128px] dk-flex dk-flex-col dk-relative dk-max-w-full">
          <div className="highlight dk-grid dk-grid-cols-6 dk-pb-5 dk-border-b-[1px] dk-border-b-[#222]">
            ...
            <div className="dk-col-span-2 dk-flex dk-flex-col dk-border-l-[1px] dk-border-l-[#222] dk-pl-5">
          ...
          <div className="content-article dk-flex dk-flex-col dk-mt-5 dk-w-full dk-gap-5">
            <article className="dk-flex dk-flex-nowrap dk-gap-5">
              <a href="/" className="dk-w-[25%]  dk-h-fit">
                <img
                  className="dk-w-full dk-aspect-[3/2]"
                  src="https://nlv.gov.vn/images/stories/thumbs/com_content/2806/jvnews_200x150.png"
                />
              </a>
              <div className="title">
                <h3 className="dk-Inter dk-leading-6 dk-font-semibold dk-text-2xl">
                  <a href="/">{`Vụ trộm tôm hùm ở Hà Nội: Nhiều người tố "tên trộm mặc bộ đồ xám"`}</a>
                </h3>
                <span className="dk-mt-5">
                  <a href="/">
                    Cơn mưa lớn giữa trưa khiến nhiều tuyến đường ở TPHCM ngập
                    sâu. Nhiều xe máy, xe tải chết máy phải đẩy bộ, người dân
                    dùng xô tát nước ra khỏi nhà.
                  </a>
                </span>
              </div>
            </article>
