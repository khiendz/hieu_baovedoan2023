...
const CollectionCreateForm: React.FC<CollectionEditFormProps> = ({
  ...
  return (
    <Modal
      open={open}
      title="Cập nhật thông tin loại nhân viên"
      okText="Cật nhật loại nhân viên"
      cancelText="Hủy"
      onCancel={onCancel}
      onOk={() => {
        save();
    ...
    >
      ...
      >
        <Form.Item
          ...
          rules={[
            { required: true, message: "Làm ơn nhập tên loại nhân viên" },
          ]}
        >
          <Input />
        </Form.Item>
        <Form.Item
          ...
          rules={[
            { required: true, message: "Làm ơn nhập mô tả loại nhân viên" },
          ]}
        >
          <Input />
        </Form.Item>
